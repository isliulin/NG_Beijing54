 ...
 ****************************************************************************
 *                                                                          *
 *    CVS: $Id: ZipFileBuf.cc,v 1.1.1.1 2006/02/26 11:59:24 dems14m1 Exp $
 *                                                                          *
 **************************************************************************** 
 *                                                                          *
 *    \file    ZipFileBuf.cc    
 *    \brief   The implementation part of ZipFileBuf
 *    \author  uli                                                          * 
 *                                                                          *
 ****************************************************************************/ 
...
int
ZipFileBuf::setcompression(int comp_level,
                          int comp_strategy)
{
...
// Open gzipped file
ZipFileBuf*
ZipFileBuf::open(const char *name,
