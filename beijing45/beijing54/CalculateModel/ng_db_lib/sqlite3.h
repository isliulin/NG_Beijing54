...
typedef int (* my_callback16)(void *NotUsed, int argc, wchar_t **argv, wchar_t **azColName);
/************************************************************************/
// my_sqlite3_exec16
// ÃèÊö£ºÖ´ÐÐSQL²éÑ¯Óï¾ä (¿í×Ö·û´®)
// Add by Liujz @ 20101015
/************************************************************************/
int my_sqlite3_exec16(sqlite3 *db, const wchar_t *zSql, my_callback16 xCallback, void *pArg, char **pzErrMsg);